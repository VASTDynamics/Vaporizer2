...
//==============================================================================
VASTLFOEditorPane::VASTLFOEditorPane (AudioProcessorEditor *editor, AudioProcessor* processor, String parameterSuffix)
    : myEditor((VASTAudioProcessorEditor*)editor), myProcessor((VASTAudioProcessor*)processor),  mySuffix(parameterSuffix)
{
...
void VASTLFOEditorPane::resized()
{
    ...
    c_lfoEditor->setBounds (proportionOfWidth (0.0000f), proportionOfHeight (0.1847f), proportionOfWidth (1.0000f), proportionOfHeight (0.8153f));
    ...
    label3->setBounds (proportionOfWidth (0.2550f), proportionOfHeight (0.0836f), proportionOfWidth (0.0963f), proportionOfHeight (0.0383f));
    label4->setBounds (proportionOfWidth (0.3488f), proportionOfHeight (0.0836f), proportionOfWidth (0.0963f), proportionOfHeight (0.0383f));
    m_uLFOWave->setBounds (proportionOfWidth (0.0125f), proportionOfHeight (0.0801f), proportionOfWidth (0.1075f), proportionOfHeight (0.0488f));
    label6->setBounds (proportionOfWidth (0.6475f), proportionOfHeight (0.0836f), proportionOfWidth (0.0963f), proportionOfHeight (0.0383f));
    m_uLFOTimeBeats->setBounds (proportionOfWidth (0.9350f), proportionOfHeight (0.0801f), proportionOfWidth (0.0500f), proportionOfHeight (0.0488f));
    m_bLFOSynch->setBounds (proportionOfWidth (0.8163f), proportionOfHeight (0.0697f), proportionOfWidth (0.0225f), proportionOfHeight (0.0627f));
    m_bLFORetrigOnOff->setBounds (proportionOfWidth (0.7438f), proportionOfHeight (0.0697f), proportionOfWidth (0.0225f), proportionOfHeight (0.0627f));
    label5->setBounds (proportionOfWidth (0.5613f), proportionOfHeight (0.0836f), proportionOfWidth (0.0963f), proportionOfHeight (0.0383f));
    m_bLFOPerVoice->setBounds (proportionOfWidth (0.6575f), proportionOfHeight (0.0697f), proportionOfWidth (0.0225f), proportionOfHeight (0.0627f));
    m_uLFOPolarity->setBounds (proportionOfWidth (0.2200f), proportionOfHeight (0.0801f), proportionOfWidth (0.0800f), proportionOfHeight (0.0488f));
    label7->setBounds (proportionOfWidth (0.4375f), proportionOfHeight (0.0836f), proportionOfWidth (0.0963f), proportionOfHeight (0.0383f));
    m_fLFORamp->setBounds (proportionOfWidth (0.4375f), proportionOfHeight (0.0279f), proportionOfWidth (0.0500f), proportionOfHeight (0.1394f));
    m_fLFOPhase->setBounds (proportionOfWidth (0.5250f), proportionOfHeight (0.0279f), proportionOfWidth (0.0500f), proportionOfHeight (0.1394f));
    m_fLFOFreq->setBounds (proportionOfWidth (0.3500f), proportionOfHeight (0.0279f), proportionOfWidth (0.0500f), proportionOfHeight (0.1394f));
    m_uLFOMSEG->setBounds (proportionOfWidth (0.1300f), proportionOfHeight (0.0801f), proportionOfWidth (0.0800f), proportionOfHeight (0.0488f));
...
<JUCER_COMPONENT documentType="Component" className="VASTLFOEditorPane" componentName=""
                 parentClasses="public Component" constructorParams="AudioProcessorEditor *editor, AudioProcessor* processor, String parameterSuffix"
                 variableInitialisers="myEditor((VASTAudioProcessorEditor*)editor), myProcessor((VASTAudioProcessor*)processor),  mySuffix(parameterSuffix)"
  ...
  <LABEL name="new label" id="b688b6b2463f3740" memberName="label3" virtualName=""
         explicitFocusOrder="0" pos="25.5% 8.362% 9.625% 3.833%" textCol="ffe2e2e2"
  ...
  <LABEL name="new label" id="28184510b080f51e" memberName="label4" virtualName=""
         explicitFocusOrder="0" pos="34.875% 8.362% 9.625% 3.833%" textCol="ffe2e2e2"
  ...
  <COMBOBOX name="m_uLFOWave" id="c27f0b9212832e6d" memberName="m_uLFOWave"
            virtualName="VASTParameterComboBox" explicitFocusOrder="0" pos="1.25% 8.014% 10.75% 4.878%"
  ...
  <LABEL name="new label" id="934694a991b7eb85" memberName="label6" virtualName=""
         explicitFocusOrder="0" pos="64.75% 8.362% 9.625% 3.833%" textCol="ffe2e2e2"
  ...
  <TOGGLEBUTTON name="m_bLFORetrigOnOff" id="750b55253d7aa8cb" memberName="m_bLFORetrigOnOff"
                virtualName="VASTParameterButton" explicitFocusOrder="0" pos="74.375% 6.969% 2.25% 6.272%"
  ...
  <LABEL name="new label" id="35c64de5ec941734" memberName="label5" virtualName=""
         explicitFocusOrder="0" pos="56.125% 8.362% 9.625% 3.833%" textCol="ffe2e2e2"
  ...
  <TOGGLEBUTTON name="m_bLFOPerVoice" id="3b7cb0db2f4b078a" memberName="m_bLFOPerVoice"
                virtualName="VASTParameterButton" explicitFocusOrder="0" pos="65.75% 6.969% 2.25% 6.272%"
  ...
  <COMBOBOX name="m_uLFOPolarity" id="fbd393b799b5d766" memberName="m_uLFOPolarity"
            virtualName="VASTParameterComboBox" explicitFocusOrder="0" pos="22% 8.014% 8% 4.878%"
  ...
  <LABEL name="new label" id="ce460ed8854a1e9e" memberName="label7" virtualName=""
         explicitFocusOrder="0" pos="43.75% 8.362% 9.625% 3.833%" textCol="ffe2e2e2"
  ...
  <SLIDER name="m_fLFORamp" id="d082b2f7dddc2836" memberName="m_fLFORamp"
          virtualName="VASTParameterSlider" explicitFocusOrder="0" pos="43.75% 2.787% 5% 13.937%"
  ...
  <SLIDER name="m_fLFOPhase" id="c8204fb330320747" memberName="m_fLFOPhase"
          virtualName="VASTParameterSlider" explicitFocusOrder="0" pos="52.5% 2.787% 5% 13.937%"
  ...
  <SLIDER name="m_fLFOFreq" id="e40a662fd508c4e5" memberName="m_fLFOFreq"
          virtualName="VASTParameterSlider" explicitFocusOrder="0" pos="35% 2.787% 5% 13.937%"
