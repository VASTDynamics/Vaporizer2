...
void CVASTEq::initParameters() {
	...
	createAndAddParameter(&m_bEQOnOff, parameters, 0, "m_bEQOnOff", "EQ on / off", "On", 0,
	...
	createAndAddParameter(&m_fEQ1, parameters, 0, "m_fEQ1", "EQ low shelf", "Low", 1,
		MODMATDEST::NoDestination,
		...
		true);
	createAndAddParameter(&m_fEQ2, parameters, 0, "m_fEQ2", "EQ notch at +/- 250hz", "250hz", 2,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQ3, parameters, 0, "m_fEQ3", "EQ notch at +/- 500hz", "500hz", 3,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQ4, parameters, 0, "m_fEQ4", "EQ notch at +/- 1kHz", "1kHz", 4,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQ5, parameters, 0, "m_fEQ5", "EQ notch at +/- 2kHz", "2kHz", 5,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQ6, parameters, 0, "m_fEQ6", "EQ notch at +/- 4kHz", "4kHz", 6,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQ7, parameters, 0, "m_fEQ7", "EQ notch at +/- 8kHz", "8kHz", 7,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQ8, parameters, 0, "m_fEQ8", "EQ high shelf", "High", 8,
		MODMATDEST::NoDestination,
		NormalisableRange<float>(-20, 20), 0,
		CVASTParamState::floatSliderValueToTextFunction,
		CVASTParamState::floatSliderTextToValueFunction,
		false, true, false, false,
		true);
	createAndAddParameter(&m_fEQGain, parameters, 0, "m_fEQGain", "EQ output gain", "Gain", 9,
		MODMATDEST::EQGain,
