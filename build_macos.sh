#!/usr/bin/env bash
clear
# declare -a targets=("macOS64" "macOS64SSE2" "macOS32" "ARM64")
declare -a targets=("ARM64")
...
do
    ...
    if [ $t == "macOS64SSE2" ]
    then
        cmake -B"cmake-build\x64SSE2" -DCMAKE_PREFIX_PATH=../JUCE/install -DCMAKE_OSX_ARCHITECTURES="x86_64" -DBUILD_AVX=OFF -DBUILD_32=OFF -DAAX_SDK_LOCATION:STRING="../../AAX_SDK/aax-sdk-2-6-0" -DVST2_SDK_LOCATION:STRING="../../VST_SDK/VST2_SDK" 
    ...
    if [ $t == "ARM64" ]
    then
        cmake -B"cmake-build\ARM64" -DCMAKE_PREFIX_PATH=../JUCE/install -DCMAKE_OSX_ARCHITECTURES="x86_64;arm64" -DBUILD_AVX=ON -DBUILD_32=ON -DAAX_SDK_LOCATION:STRING="../../AAX_SDK/aax-sdk-2-6-0" -DVST2_SDK_LOCATION:STRING="../../VST_SDK/VST2_SDK" 
        cmake --build "cmake-build\ARM64" --config Release
    fi
done