...
cmake -B"cmake-build\x64" -DCMAKE_BUILD_TYPE=Release -DCMAKE_SYSTEM_VERSION=10.0.22000.0 -G "Visual Studio 16 2019" -T v142 -A x64 -DCMAKECXX_FLAGS="/MT" -DCMAKECXX_FLAGS_RELEASE="/MT" -DCMAKECXX_FLAGS_DEBUG="/MTd" -DCMAKE_OSX_DEPLOYMENT_TARGET=10.13 -DBUILD_SHARED_LIBS=0 -DENABLE_FLOAT=1 -DENABLE_SSE=1 -DENABLE_SSE2=1 -DENABLE_AVX=1 -DENABLE_AVX2=0
